...
import CommentsForScorecard from "./CommentsForScorecard";
...
export default function UserScorecard({ scorecard, isActive }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* <FadeInSection>
                <CommentsForScorecard fighterAName={'Terrance Crawford'} fighterBName={'Canelo Alvarez'} scorecard={scorecard} />
      </FadeInSection> */}
    </div>
  );
}
